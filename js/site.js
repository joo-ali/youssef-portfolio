(() => {
  const translations = {
    en: {
      ...
      "actions.themeDark": "Switch to graphite theme",
      "actions.themeLight": "Switch to navy theme",
    ...
    ar: {
      ...
      "actions.themeDark": "التبديل إلى الثيم الجرافيتي",
      "actions.themeLight": "التبديل إلى الثيم الكحلي",
